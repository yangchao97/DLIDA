...
with open('./objs_data/10_10/objs_data_y_high_low_10050.pkl', 'rb') as objs_data_high_low_file:
    init_test_x_and_y_high_low = pickle.load(objs_data_high_low_file)
...
# test_x_Adam_aver_list = []      # 正常报价
# test_y_Adam_aver_list = []
# a_equal_d_Adam_list = []

test_x_Adam_high_low_10050_aver_list = []     # 恶意报价,需要更换的话直接更换名称即可
test_y_Adam_high_low_10050_aver_list = []
a_equal_d_Adam_high_low_10050_list = []
"""
model_SGD迭代
"""
...
"""
model_Adam迭代，作为主要的参考方法，其中的代码与其他三种方法有点区别，具体表现为x，y，a的list的记录。
"""
...
for iteration_order in range(iteration):
    ...
    test_x_Adam_high_low_10050_aver_list.append(test_x_Adam_aver.item())        # 记录恶意报价x每次迭代的变化
    ...
    test_y_Adam_high_low_10050_aver_list.append(test_y_Adam_aver.item())        # 记录恶意报价y每次迭代的变化
    ...
    test_x_and_y = combination_x_y.combination_x_y_max(test_x, test_y)
    a_equal_d_Adam_high_low_10050_list.append(a_equal_d_Adam_aver.item())
    if iteration_order >= 1:
...
txt_name_list = ["./list_data/10_10/test_x_Adam_high_low_10050_aver_list.txt",
                 "./list_data/10_10/test_y_Adam_high_low_10050_aver_list.txt",
                 "./list_data/10_10/a_equal_d_Adam_high_low_10050_list.txt"]          # 恶意报价x_list,y_list

txt_list = [test_x_Adam_high_low_10050_aver_list, test_y_Adam_high_low_10050_aver_list, a_equal_d_Adam_high_low_10050_list]

for txt_number in range(3):                                    # 只需要3组数据
...
print("test_x_Adam_high_low_10050_aver_list:")
print(test_x_Adam_high_low_10050_aver_list)
print("test_y_Adam_high_low_10050_aver_list:")
print(test_y_Adam_high_low_10050_aver_list)
print("a_equal_d_Adam_high_low_10050_list:")
print(a_equal_d_Adam_high_low_10050_list)
